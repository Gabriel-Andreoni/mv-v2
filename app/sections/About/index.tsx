...
export function About() {
  return (
    <section className="w-full h-auto p-[6em]">
      <h2 className="mb-2 text-center text-[6em] text-[#a52a2a]">Sobre Nós</h2>
      ...
      <div className="w-full h-full flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-[2em] pt-[2em] pl-[2em] pb-[2em]">
          ...
          >
            <div className="absolute inset-0 bg-black/50 rounded-[0.8em]" />
            <h2 className="text-white text-[1.8em] z-10">Projetos Personalizados</h2>
            <p className="w-[80%] text-white text-[1.1em] text-balance mb-8 z-10">
